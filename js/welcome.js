// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=KEd3A8FzEWw4nQB5a6I5O9Vb0k') // 申请地址：https://api.nsmao.net
    .then(response => {
        if (!response.ok) {
...
function showWelcome() {
    ...
    let dist = getDistance(112, 22, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
